const Article = ({ data }) => {
  return (
    <article
      className={
        data.id == 1
          ? "bg-Moderate-violet  rounded-lg px-10 py-8 text-white  shadow-xl leading-[1.4] relative col-span-2 m-4 max-sm:col-span-1"
          : data.id == 2
          ? "bg-Very-dark-grayish-blue rounded-lg px-10 py-8 text-white  shadow-xl leading-[1.4] m-4 max-lg:row-span-2 n-1"
          : data.id == 3
    ...
    >
      ...
      <div className="flex">
        <img
          className={
            data.id == 4
              ? "rounded-full border-2 border-Moderate-violet  w-10 h-10 mr-4"
              : data.id == 2
              ? "rounded-full border-2 border-Very-dark-grayish-blue border-opacity-30 w-10 h-10 mr-4"
              : "rounded-full border-2 border-white border-opacity-30 w-10 h-10 mr-4"
          }
          src={data.img}
          alt="person photo"
        />
